...
const Sidebar = ({
  ...
  const shouldRenderSidebar =
    isMobile || layout === "Sidenav" || layout === "Combo";

  const baseContainer =
    "transition-all duration-300 border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700 min-w-0";
  ...
  const drawerBase =
    "fixed inset-y-0 left-0 z-50 transform transition-transform duration-300 ease-in-out bg-gray-900";
      ...
      >
        <div className="flex flex-col h-full overflow-hidden">
          ...
          <div className="flex items-center justify-between p-3 h-16 border-b border-gray-700 flex-shrink-0">
            ...
            {isMobile || !isCollapsed ? (
              ...
              <div className="w-12 flex items-center justify-center flex-none">
                <div className="w-6 h-6 flex items-center justify-center text-xl font-bold text-blue-500">
                  Z
                </div>
              </div>
            )}
            ...
            <div className="flex items-center gap-2 flex-none">
              ...
              {!isMobile && (
                <button
                  ...
                  className="inline-flex p-1 rounded-full text-gray-400 hover:bg-gray-700 hover:text-blue-400 focus:outline-none"
                  aria-label={
          ...
          <nav className="p-2 space-y-1 overflow-y-auto flex-1 min-w-0">
            ...
            {shouldRenderMainNav && (
              <div className="py-2 border-t border-gray-700 mt-4" />
            )}
                ...
                {Object.keys(courseCatalog).map((key) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-400 mt-0.5 truncate min-w-0">
                        {course.description}
                      </p>
                    </button>
                  );
                ...
                {Object.keys(courseCatalog).map((key) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-10 h-10 mx-auto rounded-md flex justify-center items-center transition-colors duration-150 ${
                        isActive
